  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Box sx={{ 
        ...
        <Button color="error" variant="contained" onClick={handleLogout} fullWidth={{ xs: true, sm: false }}>
          Logout
        </Button>
      </Box>
      ...
      <Card sx={{ mb: 4 }}>
        <CardContent>
          ...
          {/* Quick Date Buttons: Scrollable on mobile */}
          <Box sx={{ 
            display: "flex", 
            gap: 1, 
            mb: 3, 
            ...
            {["today", "yesterday", "last7", "thisMonth", "reset"].map((opt) => (
              <Button key={opt} size="small" variant="outlined" onClick={() => handleQuickDate(opt)}>
                {opt.replace(/([A-Z])/g, ' $1').replace(/^./, str => str.toUpperCase())}
              </Button>
            ))}
            <Button size="small" variant="contained" onClick={() => setCustomRangeOpen(!customRangeOpen)}>
              Custom Range
            </Button>
          </Box>
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <Box sx={{ 
                ...
                <Stack direction="row" spacing={2} sx={{ width: { xs: '100%', md: 'auto' } }}>
                  <Button fullWidth variant="contained" onClick={handleCustomRangeApply}>Apply</Button>
                  <Button fullWidth variant="outlined" color="error" onClick={handleCustomRangeCancel}>Cancel</Button>
                </Stack>
              </Box>
            </LocalizationProvider>
          )}
          ...
          <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
            <FormControl fullWidth sx={{ maxWidth: { sm: 200 } }}>
              <InputLabel>Age</InputLabel>
              <Select name="age" value={filters.age} label="Age" onChange={handleFilterChange}>
                <MenuItem value="">All</MenuItem>
                <MenuItem value="<18">&lt;18</MenuItem>
                <MenuItem value="18-40">18-40</MenuItem>
                <MenuItem value=">40">&gt;40</MenuItem>
              ...
              <Box sx={{ width: '100%', height: 300 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={lineData}>
                    ...
                    <Line type="monotone" dataKey="clicks" stroke="#6366f1" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }} />
                  </LineChart>
                </ResponsiveContainer>
              </Box>
            </CardContent>
