        ...
        <CardContent>
          ...
          >
            <FormControl fullWidth>
              <InputLabel sx={{ color: "#050608" }}>Age</InputLabel>
              <Select
                name="age"
                value={filters.age}
            ...
            <FormControl fullWidth>
              <InputLabel sx={{ color: "#050608" }}>Gender</InputLabel>
              <Select
                name="gender"
            ...
            <CardContent>
              ...
              <Box sx={{ width: "100%", overflowX: "auto" }}>
                <BarChart width={500} height={300} data={barData}>
                  <XAxis dataKey="feature" stroke="#103cec" />
                  <YAxis stroke="#103cec" />
                  <Tooltip
                    contentStyle={{
            ...
            <CardContent>
              ...
              <Box sx={{ width: "100%", overflowX: "auto" }}>
                <LineChart width={500} height={300} data={lineData}>
                  <XAxis dataKey="date" stroke="#103cec" />
                  <YAxis stroke="#103cec" />
                  <Tooltip
                    contentStyle={{
                      backgroundColor: "#1f2937",
